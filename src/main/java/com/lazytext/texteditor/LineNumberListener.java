...
public class LineNumberListener implements CaretListener {
  ...
  public void caretUpdate(CaretEvent e) {
    ...
    try {
      // First find the position of the caret. This is the number of where the
      // caret is in relation to the start of the JTextArea in the upper left
      // corner. We use this position to find offset values (eg what line we are
      // on for the given position as well as what position that line starts on.
      ...
      // position.
      // So lets say that we are on line 5 and that line starts at caret
      // position 100, if our caret position is currently 106 we know that we
      // must be on column 6 of line 5.
