...
public class ThemeChooser {
    ...
    private void setJListConstraints() {
        ...
        this.availableThemes.setSelectionMode(ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void initializeScrollBars() {
        this.scrollPne = new JScrollPane(this.availableThemes, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
    ...
    private void themeListScrollBarTheme(Color scrollBarThumbColor, Color bgColor) {
    ...
    private void themeComponents() {
        String[] colorValues = this.window.getThemeObject().getParsedThemeValues("themeChooserMenu");
        this.themeListTheme(Theme.getColorValue(colorValues[1]), Theme.getColorValue(colorValues[0]));
        this.themeListScrollBarTheme(Theme.getColorValue(colorValues[1]), Theme.getColorValue(colorValues[0]));
        this.themePanelTheme(Theme.getColorValue(colorValues[1]), Theme.getColorValue(colorValues[0]));
    ...
    private void assignXCoordinate() {
        ...
        } else if (searchBoxLocationX == 1920.0) {
            this.x = (int) searchBoxLocationX - 1150;
        } else {
            this.x = (int) searchBoxLocationX - 600;
        }
