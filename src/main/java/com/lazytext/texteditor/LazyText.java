...
public class LazyText {
    ...
    private void initializeFrame() {
        ...
        ImageIcon windowIcon = new ImageIcon("src/main/resources/lazy_text_logo.png");
    ...
    private void initializeTextArea() {
        ...
        this.scrollableTextArea = new JScrollPane(this.textArea, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
    ...
    private JTextPane createStatusBarTextPane(String initialValue, int width, int height) {
    ...
    private void initializeStatusBarComponents() {
        this.statusBar.add(this.createStatusBarTextPane("Line: 1  Column: 1", 200, 20));
        this.statusBar.add(Box.createGlue());
        this.statusBar.add(this.createStatusBarTextPane("Text", 65, 20));
    ...
    private void setAccelerator(int keyCode, JMenuItem newMenuItem) {
        newMenuItem.setAccelerator(KeyStroke.getKeyStroke(keyCode, ActionEvent.CTRL_MASK));
    ...
    public String getLastSearchedValue() {
        return this.lastSearchedValue;
    }

    public JScrollPane getScrollPane() {
        return this.scrollableTextArea;
    }

    public JTextArea getLinedNumberArea() {
